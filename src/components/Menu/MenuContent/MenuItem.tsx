    ...
    return (
            ...
            <Tilt tiltReverse glareEnable glareReverse>
                <div 
                    ...
                    before:absolute before:top-0 before:right-0 before:bottom-0 before:left-0 before:bg-[url(/small-shadow-exp.png)]  before:bg-cover before:bg-no-repeat before:bg-right   before:opacity-35 sm:before:opacity-0 sm:hover:before:opacity-100 before:transition-opacity before:ease-in-out'>
