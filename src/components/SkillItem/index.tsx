  ...
  return (
    <div className=''>
        ...
        <div className='mt-1 xl:mt-2'>
            <h3 className='text-xs sm:text-[.85rem] uppercase text-gold font-bold mb-1'>{data.subSkills.title}</h3>
            <ul className='text-xs sm:text-[.85rem] xl:text[.85rem] pl-4 text-stone-700'>
